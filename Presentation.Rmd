...
1. Summarize (quasi-)experimental studies
...
Searched for studies published between 1980 and 2005
...
## Meta-analysis on heterogeneous bodies of literature

Meta-analysis designed to summarize highly similar studies
...
## Recursive pre-selection algorithm
...
names(print_table)[2:6] <- c("Beta all predictors", "p all predictors", "Beta one at a time", "p one at a time", "MF importance")
